...
type BaseModule struct {
	...
	ModuleIcon  string `gorm:"column:module_icon;type:VARCHAR(300)" json:"module_icon,omitempty" yaml:"module_icon,omitempty" field-id:"module_icon" field-type:"varchar" field-comment:"模块图标"`    // 模块图标
	...
	ViewType    string `gorm:"column:view_type;type:VARCHAR(30)" json:"view_type,omitempty" yaml:"view_type,omitempty" field-id:"view_type" field-type:"varchar" field-comment:"模块视图类型"`               // 模块视图类型
	ViewSize    string `gorm:"column:view_size;type:VARCHAR(30)" json:"view_size,omitempty" yaml:"view_size,omitempty" field-id:"view_size" field-type:"varchar" field-comment:"模块视图大小"`               // 模块视图大小
	...
	NavType     string `gorm:"column:nav_type;type:VARCHAR(30)" json:"nav_type,omitempty" yaml:"nav_type,omitempty" field-id:"nav_type" field-type:"varchar" field-comment:"模块导航类型"`                   // 模块导航类型
	NavPosition string `gorm:"column:nav_position;type:VARCHAR(30)" json:"nav_position,omitempty" yaml:"nav_position,omitempty" field-id:"nav_position" field-type:"varchar" field-comment:"在导航条位置"`   // 在导航条位置
	DynApi      string `gorm:"column:dyn_api;type:VARCHAR(300)" json:"dyn_api,omitempty" yaml:"dyn_api,omitempty" field-id:"dyn_api" field-type:"varchar" field-comment:"动态导航数据API"`                   // 动态导航数据API
	...
	IconSize    string `gorm:"column:icon_size;type:VARCHAR(30)" json:"icon_size,omitempty" yaml:"icon_size,omitempty" field-id:"icon_size" field-type:"varchar" field-comment:"图标大小"`                 // 图标大小
